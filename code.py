...
first_std_deviation_start, first_std_deviation_end = mean-standard_dev, mean+standard_dev
second_std_deviation_start, second_std_deviation_end = mean-(2* standard_dev), mean+(2*standard_dev)
third_std_deviation_start, third_std_deviation_end = mean-(3*standard_dev), mean+(3*standard_dev)
...
fig.add_trace(go.Scatter(x=[first_std_deviation_start, first_std_deviation_start], y=[0, 0.03], mode="lines", name="STD_DEV_1"))
fig.add_trace(go.Scatter(x=[first_std_deviation_end, first_std_deviation_end], y=[0, 0.03], mode="lines", name="STD_DEV_1"))

fig.add_trace(go.Scatter(x=[second_std_deviation_start, second_std_deviation_start], y=[0, 0.03], mode="lines", name="STD_DEV_2"))
fig.add_trace(go.Scatter(x=[second_std_deviation_end, second_std_deviation_end], y=[0, 0.03], mode="lines", name="STD_DEV_2"))
...
print("Standard deviation of this data is {}".format(standard_dev))
